...
<%
	Map<String,Object> homePageMap = (Map<String,Object>)request.getAttribute("HOMEPAGE_MAP");
	Map<String,String> newsMap = (Map<String,String>)homePageMap.get("LATEST_NEWS");
	List<Gallery> bannerList = (List<Gallery>)homePageMap.get("BANNER_IMG");
	List<Gallery> galleryList = (List<Gallery>)homePageMap.get("GALLERY_IMG");		
%>
<script type="text/javascript">

</script>
<body style="background-color:#000" onload="">
<div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"><%=newsMap.get("header") %>
    <div id="lorem" style="padding-top: 10px;">
	<p style="color:#fff"><%=newsMap.get("body") %></p>
    </div>
			            ...
			            <div class="col-lg-7 banner-carousel">
			                    ...
			                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
									    ...
									    <%
								         ...
								         %>
									        <img src="data:image/jpg;base64,<%=bannerList.get(i).getBase64Image() %>" alt="Los Angeles" style="width:100%;max-height:410px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    ...
                    <a class="btn hvr-hover service-title" href="#">Meeting Desk</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
